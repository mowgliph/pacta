...
export const commonValidators = {
  ...
  price: z.number().nonnegative('El precio no puede ser negativo').multipleOf(0.01, 'El precio debe tener máximo 2 decimales'),
  
  // Validador para porcentajes
  percentage: z.number().min(0, 'El porcentaje no puede ser menor a 0').max(100, 'El porcentaje no puede ser mayor a 100'),
  ...
  name: z.string().min(2, 'Debe tener al menos 2 caracteres').max(100, 'No puede exceder 100 caracteres'),
  ...
  regex: {
    ...
    passwordMessage: 'Debe contener al menos una letra minúscula, una mayúscula, un número y un carácter especial',
