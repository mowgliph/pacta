...
export const createBulkUserCreateSchema = () => {
  ...
  ).min(1, 'At least one user is required').max(100, 'Maximum of 100 users can be created at once');
};
...
export const createBulkUserUpdateSchema = () => {
  ...
  ).min(1, 'At least one user is required').max(100, 'Maximum of 100 users can be updated at once');
}; 