export const IPC_CHANNELS = {
  ...
  STATISTICS: {
    ...
    CONTRACTS_RENEWED_BY_PERIOD: 'statistics:contracts-renewed-by-period',
    CONTRACTS_ACTIVE_GROWTH: 'statistics:contracts-active-growth',
    CONTRACTS_AMOUNT_DISTRIBUTION: 'statistics:contracts-amount-distribution',
    CONTRACTS_AMOUNT_RANGES: 'statistics:contracts-amount-ranges',
    CONTRACTS_AMOUNT_TOTAL_BY_MONTH: 'statistics:contracts-amount-total-by-month',
    CONTRACTS_AMOUNT_BY_TYPE: 'statistics:contracts-amount-by-type',
    CONTRACTS_AMOUNT_BY_USER: 'statistics:contracts-amount-by-user',
    SUPPLEMENTS_COUNT_BY_CONTRACT: 'statistics:supplements-count-by-contract',
    SUPPLEMENTS_BY_MONTH: 'statistics:supplements-by-month',
    SUPPLEMENTS_FIELDS_MODIFIED: 'statistics:supplements-fields-modified',
    CONTRACTS_EXPIRING_SOON: 'statistics:contracts-expiring-soon',
    CONTRACTS_EXPIRED_NO_RENEWAL: 'statistics:contracts-expired-no-renewal',
    CONTRACTS_OVERDUE: 'statistics:contracts-overdue',
    CONTRACTS_WITHOUT_DOCUMENTS: 'statistics:contracts-without-documents',
    CONTRACTS_WITHOUT_SUPPLEMENTS: 'statistics:contracts-without-supplements',
    CONTRACTS_STATE_CHANGES: 'statistics:contracts-state-changes',
    CONTRACTS_ARCHIVED_BY_REASON: 'statistics:contracts-archived-by-reason',
    USERS_ACTIVITY: 'statistics:users-activity',
    USERS_RECENT_ACTIVITY: 'statistics:users-recent-activity',
    CONTRACTS_AVG_MANAGEMENT_TIME: 'statistics:contracts-avg-management-time',
    STATISTICS_EXPORT_CSV: 'statistics:export-csv',
